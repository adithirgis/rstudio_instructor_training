...
#### Now, using `left_join`, join band_instruments and band_members such that all the variables in band_instruments are retained, here the order of dataframes by which they are called is important
